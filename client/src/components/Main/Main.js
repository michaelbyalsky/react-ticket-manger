...
const Main = () => {
  ...
  const hideTicket = (currentTicket) => {
    axios
  ...
  return (
    <>
      <div>
        <NavBar restoreTickets={restoreTickets} doneTicketsNumber={doneTicketsNumber} ticketsLeftNumber={ticketsLeftNumber} setHiddenTickets={setHiddenTickets} hiddenTickets={hiddenTickets} setSearchText={setSearchText} searchText={searchText} />
      </div>
      <div>
        <Ticket className="Ticket" hideTicket={hideTicket} ticketsData={ticketsData} />
      </div>
    </>
  );
};
